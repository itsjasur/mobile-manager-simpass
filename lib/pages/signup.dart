                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        validator: !_noEmployeeCode ? InputValidator().validateEmployeeCode : null,
                      ),
                      const SizedBox(height: 30),
                      const Text(
                        '본인인증',
                      ...
                      TextFormField(
                        ...
                        onChanged: (value) => _birthdayCntr.text = _formatter.validateAndCorrectDate(value),
  ...
  Future<void> _submit() async {
    if (!_agreementChecked) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('개인정보 보호 약관에 동의해주세요.'),
